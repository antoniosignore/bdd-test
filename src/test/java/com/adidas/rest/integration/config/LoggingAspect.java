package com.adidas.rest.integration.config;
...
public class LoggingAspect {
    private static final String EXECUTION_EXCLUDING_GET = " !execution( public * com.adidas.rest..get*()) ";
    private static final String EXECUTION_EXCLUDING_SET = " !execution( public * com.adidas.rest..set*()) ";
    private static final String EXECUTION_EXCLUDING_CONFIG = " !execution( * com.adidas.rest..*config*..*(..)) ";
    private static final String EXECUTION_EXCLUDING_REPO = " !execution( * com.adidas.rest..*repo*..*(..)) ";
    ...
    private static final String EXECUTION_COM_ADIDAS_SAM_MICROSERVICE = EXCLUSION + "execution(* com.adidas.rest..*(..))";
